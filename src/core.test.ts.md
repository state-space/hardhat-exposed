...
> Snapshot 6
    ...
    ␊
    contract $MappingOfStructs is MappingOfStructs {␊
        bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";␊
    ␊
        mapping(uint256 => mapping(uint256 => S)) internal $v_mapping_uint256_S_;␊
    ␊
        constructor() payable {␊
        }␊
    ␊
        function $ms(uint256 arg0) external view returns (S memory) {␊
            return ms[arg0];␊
        }␊
    ␊
        function $_testMappingStructValue(uint256 t) external {␊
            super._testMappingStructValue($v_mapping_uint256_S_[t]);␊
        }␊
    ␊
        receive() external payable {}␊
    }␊
